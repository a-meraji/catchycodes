...
export default function HTMLTag() {
  ...
  const yRange1 = useTransform(scrollYProgress, [0.065, 0.13], [100, 0])
  const yRange2 = useTransform(scrollYProgress, [0.065, 0.13], [158, 0])
  useEffect(() => {
    yRange1.onChange((v) => {
  ...
  return (
    <motion.svg
      viewBox="0 0 90 72"
      className={`w-[25vw] max-w-[280px] ${percent1===0?"fill-darkAccent":"fill-[transparent]"} transition-all duration-1000`}
      xmlns="http://www.w3.org/2000/svg"
    >
      <path
        d="M15.8 52.2959L0.375977 37.5759L15.8 22.9199H23.16L7.67198 37.5759L23.16 52.2959H15.8Z"
        className="html-path stroke-darkAccent"
        strokeWidth="1"
        strokeDasharray="100"
